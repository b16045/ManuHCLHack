...
class TableItem: NSObject, NSCoding {
    ...
    func locationString() -> String {
        ...
        //Printing proximity to show the beacon reading feature. Not required on the final user side app.
...
//Defining == for comparing beacon data
func ==(item: TableItem, beacon: CLBeacon) -> Bool {
    return ((beacon.proximityUUID.uuidString==item.uuid.uuidString) && (Int(beacon.major) == Int(item.majorValue)) && (Int(beacon.minor) == Int(item.minorValue)))
}
